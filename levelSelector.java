...
public class levelSelector implements ActionListener{
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == _leveltwo) {
			startLevel = 2;
		}
		if (ae.getSource() == _levelthree) {
			startLevel = 3;
		}
		if (ae.getSource() == _levelfour) {
			startLevel = 4;
		}
		if (ae.getSource() == _levelfive) {
			startLevel = 5;
		}
		if (ae.getSource() == _levelsix) {
			startLevel = 6;
		}
		if (ae.getSource() == _levelseven) {
			startLevel = 7;
		}
		if (ae.getSource() == _leveleight) {
			startLevel = 8;
		}
		if (ae.getSource() == _levelnine) {
			startLevel = 9;
		}
		if (ae.getSource() == _levelten) {
			startLevel = 10;
		}
		if (ae.getSource() == _leveleleven) {
			startLevel = 11;
		}
	}
}
